...
Item {
    ...
    // v0.12.12 — Autosauvegarde du formulaire ouvert par QField Table.
    ...
    // v0.12.12 — sélection et modification en lot.
    ...
    // v0.12.12 — source ValueRelation complète.
    ...
    // v0.12.12 — le FeatureModel de schéma est détaché/rattaché
    ...
    // v0.12.12 : cache des libellés ValueRelation / ValueMap.
    ...
    // v0.12.12 — vues partagées synchronisées via une table du GeoPackage.
    ...
    function refreshLayers() {
        ...
        } catch (e1) { console.log("QField Table v0.12.12 mapLayers: " + e1) }
        ...
        } catch (e2) { console.log("QField Table v0.12.12 canvas layers: " + e2) }
    ...
    function inspectSelectedLayer() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 iterator: " + error)
        }
    ...
    function reloadFeaturesOnly() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 filtered iterator: " + error)
        }
        updateLoadStatus()
    ...
    function representedValue(feature, fieldName, rawValue) {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 represent_value(" + fieldName + "): " + e)
    ...
    function optimizeColumnWidths(rows) {
        // v0.12.12 : ne parcourt plus toutes les cellules au chargement.
    ...
    function parseStoredConfigurations() {
        try {
            ...
            console.log("QField Table v0.12.12 configuration invalide: " + e)
            return ({})
        }
    }
    ...
    function readLayerConfiguration() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 lecture propriété couche: " + e)
        }
        return null
    }
    ...
    function saveColumnConfiguration() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 sauvegarde propriété couche: " + e)
        }
    }
    ...
    function findSharedViewsLayer() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 recherche qfield_table_vues : " + e)
        }
    ...
    function buildProjectXmlDiagnostic(content, sourceDescription, registeredCount) {
        ...
        var lines = []
        lines.push("QField Table v0.12.12 — diagnostic projet")
    ...
    function parseProjectWidgetConfigsXml(content, sourceDescription) {
        ...
        // v0.12.12: ValueMap / Liste de valeurs is stored in the project too.
    ...
    function allProjectVectorLayers() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 ProjectUtils.mapLayers: " + e1)
        }
    ...
    function resolveProjectVectorLayer(layerIdValue, layerNameValue, layerSourceValue) {
        ...
        if (wantedId.length > 0) {
            try {
                ...
                console.log("QField Table v0.12.12 direct layer lookup: " + e0)
            }
        }
    ...
    function loadBatchRelationItemsWithIterator() {
        ...
        try {
            ...
            console.log(
                "QField Table v0.12.12 relation iterator: " + e
            )
        } finally {
            try {
                if (iterator)
    ...
    function writeBatchJournalEntryToLayer(entry) {
        ...
        try {
            ...
            // v0.12.12 : champs optionnels. Un ancien journal continue de
    ...
    function journalCloudUser() {
        try {
            ...
            console.log('QField Table v0.12.12 cloud user: ' + e)
        }
    ...
    function executeBatchEdit() {
        ...
        for (var i = 0; i < rows.length; ++i) {
            ...
            try {
                ...
                console.log("QField Table v0.12.12 batch feature " + row.featureId + ": " + e)
                batchFailedIds.push(String(row.featureId))
    ...
    function buildRows() {
        ...
        // v0.12.12 : la construction initiale ne lit plus chaque attribut de
    ...
    function zoomToFeature(featureIdValue) {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 zoom: " + zoomError)
            return false
        }
    }
    ...
    function handOffToNativeQField(featureIdValue) {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 sélection : " + selectionError)
        }
    ...
    function jumpToPendingNativeFeature() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 jumpTo : " + jumpError)
    ...
    function openNativeFeatureForm(feature) {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 formulaire natif : " + formError)
    ...
    function loadAutosaveSettings() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 réglages autosave : " + e)
            return false
        }
    }
    ...
    function saveAutosaveSettings() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 sauvegarde réglages : " + e)
            return false
        }
    }
        ...
        function inspect(item) {
            ...
            try {
                ...
                if (typeName.indexOf("ScrollBar") !== -1) {
                    try { item.width = 26 } catch (e1) {}
                    try { item.implicitWidth = 26 } catch (e2) {}
    ...
    function scrollNativeFormByWheel(wheel) {
        ...
        try {
            ...
            console.log(
                "QField Table v0.12.12 défilement formulaire : " +
                scrollError)
            return false
        }
    }
    ...
    function nativeAutosaveCurrentForm() {
        ...
        if (nativeFormIsNewEntity()) {
            console.log("QField Table v0.12.12 Autosave : nouvelle entité ignorée")
            return
        }
        ...
        try {
            if (model &&
                ...
                console.log("QField Table v0.12.12 Autosave : contrainte invalide")
                return
            }
        } catch (constraintError) {
            console.log("QField Table v0.12.12 Autosave contraintes : " +
                        constraintError)
        }
        ...
        try {
            ...
            if (ok) {
                ...
                console.log("QField Table v0.12.12 Autosave : sauvegarde réussie")
            } else {
                console.log("QField Table v0.12.12 Autosave : sauvegarde refusée")
            }

        } catch (saveError) {
            console.log("QField Table v0.12.12 Autosave erreur : " + saveError)
        }
    }
    ...
    function nativeAutosaveValueChanged() {
        ...
        console.log("QField Table v0.12.12 Autosave : modification détectée")
    }
    ...
    function saveNativeFeatureFormCore(showToast) {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 sauvegarde : " + saveError)
    ...
    function closeNativeFeatureFormAndReturn() {
        ...
        try {
            ...
            console.log(
                "QField Table v0.12.12 fermeture après sauvegarde : " +
                closeError)
    ...
    function cancelNativeFeatureForm() {
        ...
        try {
            ...
            console.log("QField Table v0.12.12 annulation : " + cancelError)
    ...
    function collectNativeEditDiagnostic(feature) {
        ...
        var text = "QField Table v0.12.12 — diagnostic formulaire natif\n\n"
    ...
    Component.onCompleted: {
        ...
        console.log("QField Table v0.12.12 chargé")
    }
    ...
    QfDialog {
        ...
        parent: mainWindow.contentItem
        modal: true
        title: qsTr("QField Table — v0.12.12")
        ...
        contentItem: ColumnLayout {
            ...
            // v0.12.12 : ListView virtualisé. Contrairement au Repeater des versions
